...
export default function RestInfo({restData}){
    ...
    return (
        ...
        <div className="flex w-full justify-between mb-2 pb-2">
            ...
            {
                count===0?(<button className="absolute bottom-0 left-20 rounded-xl text-2xl text-green-600 px-6 py-2 shadow-md border border-white bg-white " onClick={()=>handleAdditems()}>ADD</button>):(

                <div className=" absolute flex gap-2 bottom-0 left-20 text-2xl rounded-xl text-green-600 px-6 py-2 shadow-md border border-white bg-white">
